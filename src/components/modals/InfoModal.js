  ...
  render() {
    return (
      <Modal show={this.props.showModal} onHide={this.props.toggleInfoModal}>
        ...
        <Modal.Body>
          <p>Just visit <a href="https://www.leapchat.org/">leapchat.org</a> and a new, secure chat room will instantly be created for you. And once you're in, just link people to that page to invite them to join you!</p>
        <h3>
          Why LeapChat?
        </h3>
          <p>
            ...
            Plus, you can host LeapChat on your own server, since it's <a href="https://github.com/cryptag/leapchat">open source</a>!
          </p>
          <h3>
            How does it work?
          </h3>
          <p>
            ...
            <ol>
              ...
              <li>
                That JavaScript code then grabs the long passphrase at the end of the URL (the "URL hash" -- everything after the `#`), then passes it to <a href="https://github.com/kaepora/minilock">miniLock</a>, which then deterministically generates a keypair from that passphrase
              </li>
              <li>
          ...
          <p>
            <em>Yup!</em> To learn about Markdown syntax, like surrounding words with **double asterisks** to make them <b>bold</b>, or with _underscores_ to make them <i>italicized</i>,
              <a href="https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet"> check out this guide</a>.
          </p>
        </Modal.Body>
      </Modal>
    );
