...
export const CHAT_INIT_APPLICATION = 'CHAT_INIT_APPLICATION';
export const CHAT_READY_TO_CONNECT = 'CHAT_READY_TO_CONNECT';
...
export const initApplication = () =>
    ({ type: CHAT_INIT_APPLICATION });

export const readyToConnect = () => 
    ({ type: CHAT_READY_TO_CONNECT });
